...
class Version implements \PHPCR\Version\VersionInterface
{
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getContainingHistory())
    }
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getCreated())
    }
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getLinearSuccessor())
    }
