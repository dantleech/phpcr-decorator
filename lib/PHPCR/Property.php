...
class Property implements \PHPCR\PropertyInterface
{
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->setValue($value $type))
    }
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->addValue($value))
    }
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getValue())
    }
