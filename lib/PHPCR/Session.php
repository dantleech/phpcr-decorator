...
class Session implements \PHPCR\SessionInterface
{
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getRepository())
    }
    ...
    {
        return $this->getDecorator()->decorate(__METHOD__, $this->__component()->getAttributeNames())
    }
